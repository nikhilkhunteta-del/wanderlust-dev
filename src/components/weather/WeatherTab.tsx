...
export const WeatherTab = ({ city, country, travelMonth, primaryInterest, onSwitchTab }: WeatherTabProps) => {
  ...
  return (
    <div className="page-container py-8 space-y-12">
      {/* Header row: Verdict + temperature toggle */}
      ...
      <UsefulInsights weather={weather} month={travelMonth} primaryInterest={primaryInterest} />
    </div>
  );
};
